...
- Интеграционные тесты загрузки файлов и валидации MIME/расширений
...
| Integration   | Взаимодействие компонентов             | pytest-asyncio, respx                | 85%+          |
| E2E           | Полный пользовательский сценарий       | httpx + TestClient                   | 70%+          |
| Security      | Шифрование, 2FA, audit                | Bandit, custom security tests        | 100%          |
...
### 3.2 Загрузка файлов (валидация)
Файл: `tests/test_api/test_upload.py`

Проверяется успешная загрузка после валидации MIME и расширений, ошибки типа и размера файла.
